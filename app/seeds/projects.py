...
def seed_projects():
    ...
    description='''The state of California has allocated funds to STEM labs in low income schools, but in order to receive it we need to create and implement a detailed plan of how we
    will effectively use the funds ''')
