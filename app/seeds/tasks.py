...
def seed_tasks():
    t1=Task(assigneeId=1, projectId=1, name='T1 in P1 by Team1: Meet with team leads to understand current renewal processes',
    ...
    t2=Task(assigneeId=2, projectId=1, name='T2 in P1 by Team1: Review all documentation of current renewal processes',
    ...
    t3=Task(assigneeId=3, projectId=2, name='T3 in P2 by Team1: Get assessment data', description='Work with school district to get reading levels for students that will participate in at home small group tutoring', stageId=1)
    t4=Task(assigneeId=4, projectId=2, name='T4 in P2 by Team1: Send communications to parents for sign up', description='Mass text and email all eligible families in the district', stageId=2)

    t5=Task(assigneeId=5, projectId=3, name='T5 in P3 by Team2: Design new database schema', description='Review the minimum amount of change necessary to add a new permission type', stageId=1)
    t6=Task(assigneeId=6, projectId=3, name='T6 in P3 by Team2: Test new feature in development',
    ...
    t7=Task(assigneeId=7, projectId=4, name="T7 in P4 by Team2: Research parent's desires for the sign up form", description="Review parent and school leader's survey feedback on the current process", stageId=1)
    t8=Task(assigneeId=8, projectId=4, name='T8 in P4 by Team2: Meet with Customer Success and Implementation team leaders', description='Discuss the issues with the current Google and Word Press sign up form processes', stageId=2)
