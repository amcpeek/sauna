      ...
      <div className="jc-sb lr-margin vh-5 ai-c ">
        <div className="row ai-c">
          <Link to={"/"} className=" l-margin-small row no-und">
            <img className="logo" src={saunaLogo} alt="Logo"></img>
            <div> &nbsp; Sauna</div>
          </Link>
          &nbsp; &nbsp; &nbsp;
          <TeamsButton user={user} />
          &nbsp; &nbsp; &nbsp;
          <Link to="/whySauna" className="no-und">
            Why Sauna?
          </Link>
          &nbsp; &nbsp; &nbsp;
          <a
            href="https://github.com/amcpeek/sauna/wiki"
            className="no-und"
            target="_blank"
          >
            Features
          ...
          &nbsp; &nbsp; &nbsp;
          <a
            href="https://github.com/amcpeek/sauna"
            className="no-und"
            target="_blank"
          >
            Resources
