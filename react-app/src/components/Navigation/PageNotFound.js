...
function PageNotFound() {
  return (
    <div
      className="lost-sauna-img"
      style={{ backgroundImage: `url(${KemiSauna3})` }}
    >
      ...
      <div className="kemi-box">
        This page does not exist... but this amazing sauna does! My husband's
        family built it on an island off the coast of Finland.
      </div>
    </div>
  );
}
