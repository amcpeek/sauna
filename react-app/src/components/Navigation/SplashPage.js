      ...
      <div className="f">
        <div className="main-left col main-left lr-margin">
          <div className="lr-margin-small col  width-80-per">
            <h1>
              Are silos making teamwork <br /> more painful?
            </h1>
            <h4>
              Sauna, an Asana clone, helps you manage projects, focus on what's
              important, <br /> and organize work in one place for seamless
              collaboration.
            </h4>
          </div>
          ...
          <div className="lr-margin-small col width-80-per">
            <h1>
              Stay organized and <br /> connected
            </h1>
            <h4>
        ...
        <div className="main-gray-box">
          ...
          {t1 && (
            <button
              onClick={clickT1}
              className="floating-task-1 row ai-c asana-button box-shadow"
            >
          ...
          {t2 && (
            <div
              onClick={clickT2}
              className="floating-task-2 row ai-c asana-button box-shadow"
            >
              <i className="fa-regular fa-circle-check lr-margin-small"></i>
          ...
          {t3 && (
            <div
              onClick={clickT3}
              className="floating-task-3 row ai-c asana-button box-shadow"
            >
              <i className="fa-regular fa-circle-check lr-margin-small"></i>
