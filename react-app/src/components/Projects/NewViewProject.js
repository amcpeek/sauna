        ...
        return (
            ...
            <div className='col'>
                ...
                <div className='f vh-5 lr-margin-small ai-c '>
                    ...
                    <div>
                    <button onClick={() => (setListView(false),setBoardView(false), setOverView(true))} className='just-text-button  bg-white cursor'>Overview</button>
                    {overView && <div className='gray-line-med'></div> }
                    </div>
                    <div>
                    <button onClick={() => (setListView(false), setOverView(false), setBoardView(true))}  className='just-text-button bg-white cursor'>Board</button>
                    ...
                    {(user &&
                        ...
                        <div> <div className='just-text-button  bg-white text-blue'>Try Dragging and Dropping Tasks!</div> <div className='gray-line-med-none'></div></div>
                            ...
                            <div className='progColView'>
                             ...
                             {(provided, snapshot) => (
                                        <div key={1} className='columnView'>
                                             <h2 className='col-title'>To Do  {isMember && (<button className='just-text-button match-tasks' onClick={() => ( showAddTask1? setShowAddTask1(false): setShowAddTask1(true))}><i className="fa-solid fa-plus"></i></button> )} </h2>
                                            <StageColumn
                                                column={toDo}
                             ...
                             {(provided, snapshot) => (
                                        <div key={2} className='columnView'>
                                             <h2 className='col-title'>In Progress  {isMember && (<button className='just-text-button match-tasks' onClick={() => ( showAddTask2? setShowAddTask2(false): setShowAddTask2(true))}><i className="fa-solid fa-plus"></i></button> )} </h2>
                                            <StageColumn
                                                column={inProg}
                                                // setHasSubmitted={setHasSubmitted}
                                                placeholder={provided.placeholder}
                             ...
                             {(provided, snapshot) => (
                                        <div key={3} className='columnView'>
                                             <h2 className='col-title'>Complete  {isMember && (<button className='just-text-button match-tasks' onClick={() => ( showAddTask3? setShowAddTask3(false): setShowAddTask3(true))}><i className="fa-solid fa-plus"></i></button> )} </h2>
                                            <StageColumn
                                                column={complete}
                                                // setHasSubmitted={setHasSubmitted}
                                                placeholder={provided.placeholder}
