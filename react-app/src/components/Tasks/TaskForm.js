  ...
  return (
    <div className="jc-st col ai-st bg-white width-100-per all-margin-small">
      ...
      <form className=" jc-st col ai-st width-100-per" onSubmit={handleSubmit}>
        <button
          className="just-text-button bg-white b-margin"
          onClick={() => closeBox()}
        >
          X
        </button>
        ...
        <div className="">
          <div className="">{/* <h4>Validation Checking List</h4> */}</div>
        ...
        <div className="">
          <input
            type="submit"
            value={formType}
            className="asana-button b-margin"
      ...
      {formType === "Edit Task" &&
        user &&
        oneProject &&
        user.id == oneProject.ownerId && (
          <div className="">
            <button onClick={() => deleteEvents(task)} className="asana-button">
              Delete
            </button>
          </div>
        )}
      {formType === "Edit Task" &&
        ...
        oneProject &&
        user.id != oneProject.ownerId && (
          <div className="">*Only the project owner can delete tasks</div>
        )}
    </div>
    // </div>
  );
