...
const ProfilePage = () => {
  ...
  let allTasksObj = useSelector((state) => {
    return state.task;
  });
  let allTasks = Object.values(allTasksObj);
  let allProjectsObj = useSelector((state) => {
      ...
      return (
        <div className="f">
          <div className="main-left col lr-margin">
            <h1>
              You are not currently part of any teams, so you do not have access
              to teams, projects, or tasks
            </h1>
            <Link className="text-blue" to="/teams">
        ...
        <div className="profile-box">
          <div className="row ai-c width-members tb-margin lr-margin-small">
            <div
              ...
              style={{ backgroundColor: arrayOfColors[user.id] }}
            >
          ...
          <div className="row jc-sa lr-margin-small">
            <div>
              <button
                className="font-small-med no-bor bg-white"
                onClick={() => (
                  setToDo(true), setInProg(false), setComp(false)
                )}
              >
                To Do ({toDoCur && toDoCur.length}){" "}
              </button>
            ...
            <div>
              <button
                className="font-small-med no-bor bg-white"
                onClick={() => (
                  setToDo(false), setInProg(true), setComp(false)
                )}
              >
                In Progress ({inProgCur && inProgCur.length}){" "}
              </button>
            ...
            <div>
              <button
                className="font-small-med no-bor bg-white"
                onClick={() => (
                  setToDo(false), setInProg(false), setComp(true)
                )}
              >
                Completed ({compCur && compCur.length})
              </button>
                  ...
                  return (
                    <div>
                      <Link
                        ...
                        className="no-und cursor"
                      >
                        <div className="row width-100-per ai-c t-margin-05">
                          <i className="fa-regular fa-circle-check lr-margin-small"></i>
                          <div className="min-width-35vw font-med should-wrap">
                            {task.name}
                          </div>

                          <div className="min-width-5vw jc-c">
                        ...
                        >
                          <div className="row ">
                            <div className="row">
                              ...
                              <div className="jc-c ai-c lr-margin-small">
                                {project.name}{" "}
                              </div>
                            </div>
                          </div>
                ...
                >
                  <div className="row ai-c tb-margin jc-sb width-vw">
                    <div className="row">
                      ...
                      <div className="ai-c lr-margin-small font-med">
                        {" "}
                        Create Team
                      </div>
                    </div>
                          ...
                          <div className="row">
                            <div className="box-circle-mem-no-margin">
                              <div
                                className="solid-round-sq jc-c ai-c"
                                style={{
                                  backgroundColor: arrayOfColors[team.id],
                                }}
                              >
                                <i className="fa-solid fa-list-ul"></i>
                              </div>
                            ...
                            <div className="ai-c lr-margin-small">
                              {" "}
                              {team.name}{" "}
                            </div>
                          </div>
                  ...
                  return (
                    <div>
                      <div className="row width-vw jc-sb">
                        ...
                        <button
                          onClick={() => handleRemoveMembership(team.id)}
                          className="no-bor bg-white jc-st ai-c cursor pad-0"
                        >
                          <div className="dotted-round-sq jc-c ai-c font-small-med pad-02">
